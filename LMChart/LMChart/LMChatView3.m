...
- (UIBezierPath *)fillPathWihtYvalueArr:(NSArray *)yValueArr {
    ...
    [path addLineToPoint:[self linePointWithYvalue:self.yValuesArr[0] index:0]];
    
    return path;
}


- (CGPoint)linePointWithYvalue:(NSString *)yValue index:(NSInteger)index {
    ...
    if ([yValue floatValue] > 0.66) {
        ratio = 0;
    } else if ([yValue floatValue] > 0.33) {
        ratio = 0.33;
    } else if ([yValue floatValue] > 0) {
        ratio = 0.66;
    } else {
        ratio = 1;
    }
//    if ([yValue isEqualToString:@"一般"]) {
//        ratio = 1;
//    } else if ([yValue isEqualToString:@"良好"]) {
//        ratio = 0.66;
//    } else if ([yValue isEqualToString:@"优质"]) {
//        ratio = 0.33;
//    } else {
//        ratio = 0;
//    }
    
    CGFloat y = LineStartY + VerticalLineH * ratio ;
...
-(NSArray *)defaultYtitlesArr {
    if (_defaultYtitlesArr == nil) {
        _defaultYtitlesArr = @[@"一般",@"良好",@"优质",@"完美"];
    }
...
-(NSArray *)defaultYvaluesArr {
    if (_defaultYvaluesArr == nil) {
        if (self.timeType == USkinTimeTypeDay) {
            _defaultYvaluesArr = @[@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",
                                   @"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",
                                   @"一般",@"一般",@"一般",@"一般"];
        } else if (self.timeType == USkinTimeTypeWeek) {
            _defaultYvaluesArr = @[@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般"];
        } else {
            _defaultYvaluesArr = @[@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",
                                   @"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",
                                   @"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般",@"一般"];
